...
echo "==> layers: unit → contract/INV-* → integration → e2e (E2E-01..10 gates)"
...
echo "    e2e-02:    artifacts/test/e2e-02/report.json"
...
echo "    e2e-10:    artifacts/test/e2e-10/report.json"
echo "    task-25:   artifacts/test/task-25/report.json"
