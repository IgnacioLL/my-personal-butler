#!/usr/bin/env python3
"""Run E2E-03 Todo WhatsApp → Android journey (Virtual User harness).
...
from harness.virtual_user import run_e2e_03  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    del argv  # no flags yet
    result = run_e2e_03(root=ROOT, write_artifacts=True)
    summary = {
        "flow": "E2E-03",
